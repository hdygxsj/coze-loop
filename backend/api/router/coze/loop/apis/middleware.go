...
func _login_by_oauthMw(handler *apis.APIHandler) []app.HandlerFunc {
	// your code...
	return nil
}

func _loginbyoauthMw(handler *apis.APIHandler) []app.HandlerFunc {
	// your code...
	return nil
}

func _getoauthprovidersMw(handler *apis.APIHandler) []app.HandlerFunc {
	// your code...
	return nil
}
